...
/**
 * Created by Amarpreet on 30-08-2015.
 * Reference is from below
...
public class InputStreamNetwork extends BasicNetwork {
     ...
     */
    public InputStreamNetwork(HttpStack httpStack, ByteArrayPool pool) {
        ...
        while (true) {
            ...
            try {
                ...
                if (httpResponse.getEntity() != null) {
                    ...
                    if (request instanceof InputStreamRequest) {
                ...
                return new InputStreamNetworkResponse(statusCode,
                ...
                if (responseContents != null || responseIns != null) {
                    networkResponse = new InputStreamNetworkResponse(statusCode,
                            responseContents, responseIns, responseHeaders, false);
